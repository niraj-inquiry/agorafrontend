...
const AgoraManager = async (eventsCallback) => {
  ...
  const join = async (localPlayerContainer, channelParameters) => {
    await agoraEngine.join(
      '24262f89eeba4f6e8abc63c8bcceeb4b',
      'Testing',
      '007eJxTYHAL/tOk3azF9fh/fTp/h6kn48SkYD3ZVZJW71w9NacEHFJgMDIxMjNKs7BMTU1KNEkzS7VITEo2M062SEpOTk1NMkn6Mjk1lWVRaipv0kcWRgZGBhYGRgYQYAKTzGCSBUyyM4SkFpdk5qUzMxgaGQMAT8cfiQ==',
      '123'
    );
